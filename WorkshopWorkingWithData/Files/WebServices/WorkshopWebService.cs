...
namespace WorkshopWorkingWithData
{
	...
	public class WorkshopWebService : BaseService
	{
		...
		{
			//http://k_krylov:7010/0/rest/WorkshopWebService/GetAllContacts?qt=0
			Timer.Start();
		...
		{
			//http://k_krylov:7010/0/rest/WorkshopWebService/GetFilteredContacts?qt=0&email=a.baker@ac.com	
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		// Example to run: 
		// http://k_krylov:7010/0/rest/WorkshopWebService/GetAllDataReverseJoin?qt=1
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		{
			// http://k_krylov:7010/0/rest/WorkshopWebService/GetContactsWithMinutes?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		{
			// http://k_krylov:7010/0/rest/WorkshopWebService/UpdateContactName?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00&NewName=Kirill
			Timer.Start();
		...
		{
			// http://k_krylov:7010/0/rest/WorkshopWebService/InsertSeveralContacts?qt=1
			Timer.Start();
			string result = string.Empty;
			switch (qt)
			{
		...
		{
			// http://k_krylov:7010/0/rest/WorkshopWebService/DeleteContact?qt=1&ContactId=4fda7291-594a-4e3a-8156-932dc4546d3f
			Timer.Start();
			string result = string.Empty;
			switch (qt)
			{
